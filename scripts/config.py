...
AREAS = [
    Area(
        ...
        name_jp="北海道",
        name_en="Hokkaido",
        url_template="https://denkiyoho.hepco.co.jp/area/data/{date}_hokkaido_jisseki.csv",
        date_format="%Y%m%d",
    ...
    Area(
        ...
        name_jp="中部",
        name_en="Chubu",
        url_template="https://powergrid.chuden.co.jp/denkiyoho/juyo_cepco003.csv",
        date_format=None,
        encoding_candidates=("cp932", "utf-8-sig", "utf-8"),
        notes="URL path not fully confirmed - verify against chuden site if this 404s.",
    ),
    Area(
        id="hokuriku",
        name_jp="北陸",
